...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="page-title-box">
        <h4 id="head_title" class="page-title">最新消息-新增</h4>
        ...
        <div id="view" class="col-md-12 col-sm-9">
            <div class="white-box list2">
                ...
                <div class="col-lg-12 m-t-5">
                    ...
                    <div>
                        <h2 class="header-title">最新消息-新增</h2>
                        <hr />
                    </div>
                </div>
                ...
                <div class="col-lg-12 m-t-5">
                    <div class="col-lg-3 form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" id="Newsno" type="text" readonly="" placeholder="系統自動產生" runat="server" maxlength="15" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 form-horizontal">
