<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage/MasterPage.master" ValidateRequest="False" AutoEventWireup="true" CodeFile="DealersDetail_ins.aspx.cs" Inherits="Admin_DealersDetail_DealersDetail_ins" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>經銷商管理-新增</title>
    <style>
        .img {
            max-height: 150px;
            max-width: 150px;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="page-title-box">
        <h4 id="head_title" class="page-title">經銷商管理-新增</h4>
        ...
        <div id="view" class="col-md-12 col-sm-9">
            <div class="white-box list2">
                ...
                <div class="col-lg-12 m-t-5">
                    ...
                    <div>
                        <h2 class="header-title">經銷商管理-新增</h2>
                        <hr />
                    </div>
                </div>
                ...
                <div class="col-lg-12 m-t-5">
                    <div class="col-lg-3 form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" id="D_no" placeholder="系統自動產生" type="text" readonly="" runat="server" maxlength="15" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 form-horizontal">
