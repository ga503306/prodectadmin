<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage/masterpage2.master" AutoEventWireup="true" CodeFile="Yachts_Specification.aspx.cs" Inherits="Yachts_Specification" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   <asp:HiddenField ID="id" runat="server" />
    ...
    <div class="conbg">
        ...
        <!--------------------------------右邊選單開始---------------------------------------------------->
        <div id="crumb"><a href="Default.aspx">Home</a> >> <a href="Yachts.aspx">Yachts</a> >> <a href="#"><span id="ship_name_nav" runat="server" class="on1"></span></a></div>
        <div class="right">
            <div class="right1">
